...
<div class="pagetitle">Programs</div>
...
<script type="text/javascript">$(document).ready(function() {
        $('.shelp, .shelp2').click(function() {
                $('.stooltip').slideToggle("fast");
        });
    });</script>
	
<script type="text/javascript">$(document).ready(function() {
        $('.shelp3, .shelp4').click(function() {
                $('.stooltip2').slideToggle("fast");
        });
    });</script>
